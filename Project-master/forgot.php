...
<div class="form">
    ...
    <form action='#' method='post'>
        <table cellspacing='5'>
            <tr><td>user id:</td><td><input type='text' placeholder="Enter USN* ..." name='user_id' style="width: 250px; padding: 10px; border-radius: 10px; outline: none; border-color: black; font-size: 20px; color: #4B3869; background-color: #FCFFA6;" /></td></tr>
...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($con,"SELECT * FROM register where userID='" . $_POST['user_id'] . "'");
